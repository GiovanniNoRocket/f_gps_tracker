...
class _LocationState extends State<PermissionPage> {
  ...
  void initState() {
    ...
    controller = Get.find();
    // ignore: todo
    // [x]TODO: Asigna a _permissionStatus el futuro que obtiene el estado de los permisos.;
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.done &&
            ...
            if (status == LocationPermission.always ||
              ...
              //ignore:todo
              /* IGNORE TODO: Busca el controlador de ubicacion [LocationController] con [Get.find],
              ...
              //ignore:todo
              //[x] TODO: Mientras el futuro se completa muestra un CircularProgressIndicator
              return const Center(
              ...
              return Center(
                child: ElevatedButton(
                    onPressed: () {
                      setState(() {
                        // ignore: todo
                        // [x]TODO: Actualiza el futuro _permissionStatus con requestPermission
              ...
              //ignore: todo
              // [x]TODO: Muestra un texto cuando el usuario a denegado el permiso permanentemente
              return const Text("Permiso denegado permanentemente, Porfavor activa el permiso en la configuracion del dispositivo");
            }
          } else if (snapshot.connectionState == ConnectionState.done &&
              snapshot.hasError) {
            //ignore: todo
            // [x]TODO: Muestra un texto con el error si ocurre.
